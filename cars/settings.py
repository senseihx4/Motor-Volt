...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^cnclbwd+ilgqt74l@iahukvio-jd_h787rxvtiop%1vfbi8ug')
...
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', 'https://motor-volt.onrender.com').split(',')